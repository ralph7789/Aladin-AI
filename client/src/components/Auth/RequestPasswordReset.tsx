...
import { Spinner, Button } from '@aladin/client';
import { useOutletContext } from 'react-router-dom';
import { useRequestPasswordResetMutation } from 'aladin-data-provider/react-query';
import { loginPage } from 'aladin-data-provider';
import type { TRequestPasswordReset, TRequestPasswordResetResponse } from 'aladin-data-provider';
