...
import type { TPrincipal, PrincipalType, PrincipalSearchParams } from 'aladin-data-provider';
import { useSearchPrincipalsQuery } from 'aladin-data-provider/react-query';
