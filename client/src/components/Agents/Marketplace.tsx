...
import { TooltipAnchor, Button, NewChatIcon, useMediaQuery } from '@aladin/client';
import { PermissionTypes, Permissions, QueryKeys } from 'aladin-data-provider';
import type t from 'aladin-data-provider';
...
const AgentMarketplace: React.FC<AgentMarketplaceProps> = ({ className = '' }) => {
  ...
  // Set page title
  useDocumentTitle(`${localize('com_agents_marketplace')} | Aladin`);
