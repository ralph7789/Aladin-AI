...
import { PermissionTypes, Permissions } from 'aladin-data-provider';
import type { ConversationListResponse } from 'aladin-data-provider';
        ...
        <AnimatePresence initial={false}>
          {navVisible && (
            <motion.div
              data-testid="nav"
              className={cn(
                'active max-w-[320px] flex-shrink-0 overflow-x-hidden bg-surface-primary-alt/70 backdrop-blur-xl border-r border-white/10',
                'md:max-w-[260px]',
              )}
              initial={{ width: 0 }}
