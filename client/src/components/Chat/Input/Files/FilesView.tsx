import { FileSources, FileContext } from 'aladin-data-provider';
import type { TFile } from 'aladin-data-provider';
import { OGDialog, OGDialogContent, OGDialogHeader, OGDialogTitle } from '@aladin/client';
