...
import { getEndpointField } from 'aladin-data-provider';
import { useUserKeyQuery } from 'aladin-data-provider/react-query';
import { ResizableHandleAlt, ResizablePanel, useMediaQuery } from '@aladin/client';
import type { TEndpointsConfig, TInterfaceConfig } from 'aladin-data-provider';
