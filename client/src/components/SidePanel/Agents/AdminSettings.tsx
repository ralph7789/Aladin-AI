...
import { Permissions, SystemRoles, roleDefaults, PermissionTypes } from 'aladin-data-provider';
import {
  Button,
  Switch,
  OGDialog,
                  ...
                  {selectedRole === SystemRoles.ADMIN && agentPerm === Permissions.USE && (
                    <>
                      <div className="mb-2 max-w-full whitespace-normal break-words text-sm text-red-600">
                        ...
                        {'\n'}
                        <a
                          href="https://www.aladin.ai/docs/configuration/aladin_yaml/object_structure/interface"
                          target="_blank"
                          rel="noreferrer"
