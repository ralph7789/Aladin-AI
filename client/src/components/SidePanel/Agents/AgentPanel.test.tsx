...
import type { Agent } from 'aladin-data-provider';
...
jest.mock('aladin-data-provider', () => {
  const actualModule = jest.requireActual('aladin-data-provider') as any;
  return {
    ...actualModule,
    dataService: {
      updateAgent: jest.fn(),
...
jest.mock('aladin-data-provider/react-query', () => ({
...
// Import after mocks
import { dataService } from 'aladin-data-provider';
