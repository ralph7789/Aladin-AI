...
import { Button, useToastContext } from '@aladin/client';
import { Constants, QueryKeys } from 'aladin-data-provider';
import { useUpdateUserPluginsMutation } from 'aladin-data-provider/react-query';
import type { TUpdateUserPlugins } from 'aladin-data-provider';
