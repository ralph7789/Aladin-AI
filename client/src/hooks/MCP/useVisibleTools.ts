...
import { Constants } from 'aladin-data-provider';
import type { TPlugin } from 'aladin-data-provider';
 ...
 * Separates regular Aladin tools from MCP servers.
 *
 * @param selectedToolIds - Array of selected tool IDs
 * @param regularTools - Array of regular Aladin tools
