# Aladin Localization Guide

This guide explains how to add new languages to Aladin's localization system.

## Adding a New Language

To add a new language to Aladin, follow these steps:

### 1. Add the Language to Locize Project

- Navigate to the [Aladin locize project](https://www.locize.app/cat/62uyy7c9), 
...
1. The empty translation file will be populated through Aladin's automated translation platform
