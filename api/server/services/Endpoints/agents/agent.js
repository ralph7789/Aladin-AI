...
const initializeAgent = async ({
  ...
  const { resendFiles, maxContextTokens, modelOptions } = extractAladinParams(_modelOptions);
  ...
  /** @type {import('@aladin/agents').GenericTool[]} */
  ...
  /** @type {import('@aladin/agents').ClientOptions} */
