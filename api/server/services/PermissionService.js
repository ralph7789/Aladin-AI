...
const { getTransactionSupport, logger } = require('@aladin/data-schemas');
const { ResourceType, PrincipalType, PrincipalModel } = require('aladin-data-provider');
const {
...
/**
 * @import { TPrincipal } from 'aladin-data-provider'
 */
/**
