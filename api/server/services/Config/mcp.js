...
const { CacheKeys, Constants } = require('aladin-data-provider');
 ...
 * @param {import('@aladin/api').LCAvailableTools} appTools
 ...
 * @param {import('@aladin/api').LCAvailableTools} params.serverTools
 * @returns {Promise<void>}
 */
