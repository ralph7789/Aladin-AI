...
const { isEnabled, checkEmailConfig, isEmailDomainAllowed } = require('@aladin/api');
const { ErrorTypes, SystemRoles, errorsToString } = require('aladin-data-provider');
const {
  findUser,
  findToken,
  createUser,
...
const sendVerificationEmail = async (user) => {
  ...
  await sendEmail({
    ...
    payload: {
      appName: process.env.APP_TITLE || 'Aladin',
