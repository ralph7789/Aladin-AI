...
const { EnvVar } = require('@aladin/agents');
const { logger } = require('@aladin/data-schemas');
const { sanitizeFilename, parseText, processAudioFile } = require('@aladin/api');
const {
  convertImage,
  resizeAndConvert,
  resizeImageBuffer,
 ...
 * @param {RunClient} params.client - The Aladin client instance: either refers to `openai` or `streamRunManager`.
 * @param {string} params.file_id - The ID of the file to retrieve.
