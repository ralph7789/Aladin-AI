/**
 * @import { TUpdateResourcePermissionsRequest, TUpdateResourcePermissionsResponse } from 'aladin-data-provider'
 */

const mongoose = require('mongoose');
const { logger } = require('@aladin/data-schemas');
const { ResourceType, PrincipalType } = require('aladin-data-provider');
const {
