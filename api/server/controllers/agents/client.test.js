const { Providers } = require('@aladin/agents');
const { Constants, EModelEndpoint } = require('aladin-data-provider');
const AgentClient = require('./client');

jest.mock('@aladin/agents', () => ({
  ...jest.requireActual('@aladin/agents'),
...
describe('AgentClient - titleConvo', () => {
  ...
  describe('runMemory method', () => {
    ...
    it('should handle mixed content types correctly', async () => {
      ...
      const { ContentTypes } = require('aladin-data-provider');
