...
const { checkAccess, generateCheckAccess } = require('@aladin/api');
const { PermissionTypes, Permissions } = require('aladin-data-provider');
const { getRoleByName } = require('~/models/Role');
const { Role } = require('~/db/models');

// Mock the logger from @aladin/data-schemas
