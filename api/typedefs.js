...
/**
 * @exports Graph
 * @typedef {import('@aladin/agents').Graph} Graph
 * @memberof typedefs
 */

/**
 * @exports StandardGraph
 * @typedef {import('@aladin/agents').StandardGraph} StandardGraph
 * @memberof typedefs
 */

/**
 * @exports MessageContentComplex
 * @typedef {import('@aladin/agents').MessageContentComplex} MessageContentComplex
 * @memberof typedefs
 */

/**
 * @exports EventHandler
 * @typedef {import('@aladin/agents').EventHandler} EventHandler
 * @memberof typedefs
 */

/**
 * @exports ModelEndData
 * @typedef {import('@aladin/agents').ModelEndData} ModelEndData
 * @memberof typedefs
 */

/**
 * @exports ToolEndData
 * @typedef {import('@aladin/agents').ToolEndData} ToolEndData
 * @memberof typedefs
 */

/**
 * @exports ToolEndCallback
 * @typedef {import('@aladin/agents').ToolEndCallback} ToolEndCallback
 * @memberof typedefs
 */

/**
 * @exports ChatModelStreamHandler
 * @typedef {import('@aladin/agents').ChatModelStreamHandler} ChatModelStreamHandler
 * @memberof typedefs
 */

/**
 * @exports ContentAggregator
 * @typedef {import('@aladin/agents').ContentAggregatorResult['aggregateContent']} ContentAggregator
 * @memberof typedefs
 */

/**
 * @exports GraphEvents
 * @typedef {import('@aladin/agents').GraphEvents} GraphEvents
 * @memberof typedefs
 */

/**
 * @exports AgentRun
 * @typedef {import('@aladin/agents').Run} AgentRun
 * @memberof typedefs
 */

/**
 * @exports IState
 * @typedef {import('@aladin/agents').IState} IState
 * @memberof typedefs
 */

/**
 * @exports ClientCallbacks
 * @typedef {import('@aladin/agents').ClientCallbacks} ClientCallbacks
 * @memberof typedefs
 */

/**
 * @exports OpenAIClientOptions
 * @typedef {import('@aladin/agents').OpenAIClientOptions} OpenAIClientOptions
 * @memberof typedefs
 */

/**
 * @exports AnthropicClientOptions
 * @typedef {import('@aladin/agents').AnthropicClientOptions} AnthropicClientOptions
 * @memberof typedefs
 */

/**
 * @exports BedrockClientOptions
 * @typedef {import('@aladin/agents').BedrockConverseClientOptions} BedrockClientOptions
 * @memberof typedefs
 */

/**
 * @exports VertexAIClientOptions
 * @typedef {import('@aladin/agents').VertexAIClientOptions} VertexAIClientOptions
 * @memberof typedefs
 */

/**
 * @exports GoogleClientOptions
 * @typedef {import('@aladin/agents').GoogleClientOptions} GoogleClientOptions
 * @memberof typedefs
 */

/**
 * @exports StreamEventData
 * @typedef {import('@aladin/agents').StreamEventData} StreamEventData
 * @memberof typedefs
 */
 ...
 * @typedef {import('aladin-data-provider').Agents.ToolCallDelta} AgentToolCallDelta
 * @memberof typedefs
 */

/**
 * @exports ToolCallChunk
 * @typedef {import('aladin-data-provider').Agents.ToolCallChunk} ToolCallChunk
 * @memberof typedefs
 */

/**
 * @exports MessageContentImageUrl
 * @typedef {import('aladin-data-provider').Agents.MessageContentImageUrl} MessageContentImageUrl
 * @memberof typedefs
 */
 ...
 * @typedef {import('@aladin/agents').SearchResult} SearchResult
 * @memberof typedefs
 */

/**
 * @exports SearchResultData
 * @typedef {import('@aladin/agents').SearchResultData} SearchResultData
 * @memberof typedefs
 */

/**
 * @exports ValidSource
 * @typedef {import('aladin-data-provider').ValidSource} ValidSource
 * @memberof typedefs
 */
...
/**
 * @exports TPrompt
 * @typedef {import('aladin-data-provider').TPrompt} TPrompt
 * @memberof typedefs
 */

/**
 * @exports TPromptGroup
 * @typedef {import('aladin-data-provider').TPromptGroup} TPromptGroup
 * @memberof typedefs
 */

/**
 * @exports TCreatePrompt
 * @typedef {import('aladin-data-provider').TCreatePrompt} TCreatePrompt
 * @memberof typedefs
 */

/**
 * @exports TCreatePromptRecord
 * @typedef {import('aladin-data-provider').TCreatePromptRecord} TCreatePromptRecord
 * @memberof typedefs
 */
/**
 * @exports TCreatePromptResponse
 * @typedef {import('aladin-data-provider').TCreatePromptResponse} TCreatePromptResponse
 * @memberof typedefs
 */
/**
 * @exports TUpdatePromptGroupResponse
 * @typedef {import('aladin-data-provider').TUpdatePromptGroupResponse} TUpdatePromptGroupResponse
 * @memberof typedefs
 */

/**
 * @exports TPromptGroupsWithFilterRequest
 * @typedef {import('aladin-data-provider').TPromptGroupsWithFilterRequest } TPromptGroupsWithFilterRequest
 * @memberof typedefs
 */

/**
 * @exports PromptGroupListResponse
 * @typedef {import('aladin-data-provider').PromptGroupListResponse } PromptGroupListResponse
 * @memberof typedefs
 */

/**
 * @exports TGetCategoriesResponse
 * @typedef {import('aladin-data-provider').TGetCategoriesResponse } TGetCategoriesResponse
 * @memberof typedefs
 */

/**
 * @exports TGetRandomPromptsResponse
 * @typedef {import('aladin-data-provider').TGetRandomPromptsResponse } TGetRandomPromptsResponse
 * @memberof typedefs
 */

/**
 * @exports TGetRandomPromptsRequest
 * @typedef {import('aladin-data-provider').TGetRandomPromptsRequest } TGetRandomPromptsRequest
 * @memberof typedefs
 */

/**
 * @exports TUpdatePromptGroupPayload
 * @typedef {import('aladin-data-provider').TUpdatePromptGroupPayload } TUpdatePromptGroupPayload
 * @memberof typedefs
 */

/**
 * @exports TDeletePromptVariables
 * @typedef {import('aladin-data-provider').TDeletePromptVariables } TDeletePromptVariables
 * @memberof typedefs
 */

/**
 * @exports TDeletePromptResponse
 * @typedef {import('aladin-data-provider').TDeletePromptResponse } TDeletePromptResponse
 * @memberof typedefs
 */
...
/**
 * @exports TRole
 * @typedef {import('aladin-data-provider').TRole } TRole
 * @memberof typedefs
 */

/**
 * @exports PermissionTypes
 * @typedef {import('aladin-data-provider').PermissionTypes } PermissionTypes
 * @memberof typedefs
 */

/**
 * @exports Permissions
 * @typedef {import('aladin-data-provider').Permissions } Permissions
 * @memberof typedefs
 */
...
/**
 * @exports Assistant
 * @typedef {import('aladin-data-provider').Assistant} Assistant
 * @memberof typedefs
 */

/**
 * @exports AssistantDocument
 * @typedef {import('aladin-data-provider').AssistantDocument} AssistantDocument
 * @memberof typedefs
 */

/**
 * @exports OpenAIFile
 * @typedef {import('aladin-data-provider').File} OpenAIFile
 * @memberof typedefs
 */

/**
 * @exports TConfig
 * @typedef {import('aladin-data-provider').TConfig} TConfig
 * @memberof typedefs
 */

/**
 * @exports TPayload
 * @typedef {import('aladin-data-provider').TPayload} TPayload
 * @memberof typedefs
 */

/**
 * @exports TAzureModelConfig
 * @typedef {import('aladin-data-provider').TAzureModelConfig} TAzureModelConfig
 * @memberof typedefs
 */

/**
 * @exports TAzureGroup
 * @typedef {import('aladin-data-provider').TAzureGroup} TAzureGroup
 * @memberof typedefs
 */

/**
 * @exports TAzureGroups
 * @typedef {import('aladin-data-provider').TAzureGroups} TAzureGroups
 * @memberof typedefs
 */

/**
 * @exports TAzureModelGroupMap
 * @typedef {import('aladin-data-provider').TAzureModelGroupMap} TAzureModelGroupMap
 * @memberof typedefs
 */
/**
 * @exports TAzureGroupMap
 * @typedef {import('aladin-data-provider').TAzureGroupMap} TAzureGroupMap
 * @memberof typedefs
 */

/**
 * @exports TAzureConfig
 * @typedef {import('aladin-data-provider').TAzureConfig} TAzureConfig
 * @memberof typedefs
 */

/**
 * @exports TModelsConfig
 * @typedef {import('aladin-data-provider').TModelsConfig} TModelsConfig
 * @memberof typedefs
 */

/**
 * @exports TStartupConfig
 * @typedef {import('aladin-data-provider').TStartupConfig} TStartupConfig
 * @memberof typedefs
 */

/**
 * @exports TConfigDefaults
 * @typedef {import('aladin-data-provider').TConfigDefaults} TConfigDefaults
 * @memberof typedefs
 */

/**
 * @exports TPlugin
 * @typedef {import('aladin-data-provider').TPlugin} TPlugin
 * @memberof typedefs
 */

/**
 * @exports TAzureConfigValidationResult
 * @typedef {import('aladin-data-provider').TAzureConfigValidationResult} TAzureConfigValidationResult
 * @memberof typedefs
 */

/**
 * @exports EImageOutputType
 * @typedef {import('aladin-data-provider').EImageOutputType} EImageOutputType
 * @memberof typedefs
 */

/**
 * @exports TCustomConfig
 * @typedef {import('aladin-data-provider').TCustomConfig} TCustomConfig
 * @memberof typedefs
 */

/**
 * @exports TProviderSchema
 * @typedef {import('aladin-data-provider').TProviderSchema} TProviderSchema
 * @memberof typedefs
 */

/**
 * @exports TBaseEndpoint
 * @typedef {import('aladin-data-provider').TBaseEndpoint} TBaseEndpoint
 * @memberof typedefs
 */

/**
 * @exports TEndpoint
 * @typedef {import('aladin-data-provider').TEndpoint} TEndpoint
 * @memberof typedefs
 */

/**
 * @exports TEndpointsConfig
 * @typedef {import('aladin-data-provider').TEndpointsConfig} TEndpointsConfig
 * @memberof typedefs
 */

/**
 * @exports TMessage
 * @typedef {import('aladin-data-provider').TMessage} TMessage
 * @memberof typedefs
 */

/**
 * @exports TConversation
 * @typedef {import('aladin-data-provider').TConversation} TConversation
 * @memberof typedefs
 */

/**
 * @exports TModelSpec
 * @typedef {import('aladin-data-provider').TModelSpec} TModelSpec
 * @memberof typedefs
 */
...
/**
 * @exports FileSources
 * @typedef {import('aladin-data-provider').FileSources} FileSources
 * @memberof typedefs
 */
...
/**
 * @exports ImageFile
 * @typedef {import('aladin-data-provider').ImageFile} ImageFile
 * @memberof typedefs
 */

/**
 * @exports TMessageContentParts
 * @typedef {import('aladin-data-provider').TMessageContentParts} TMessageContentParts
 * @memberof typedefs
 */

/**
 * @exports StreamContentData
 * @typedef {import('aladin-data-provider').StreamContentData} StreamContentData
 * @memberof typedefs
 */

/**
 * @exports ActionRequest
 * @typedef {import('aladin-data-provider').ActionRequest} ActionRequest
 * @memberof typedefs
 */

/**
 * @exports Action
 * @typedef {import('aladin-data-provider').Action} Action
 * @memberof typedefs
 */

/**
 * @exports ActionMetadata
 * @typedef {import('aladin-data-provider').ActionMetadata} ActionMetadata
 * @memberof typedefs
 */

/**
 * @exports ActionAuth
 * @typedef {import('aladin-data-provider').ActionAuth} ActionAuth
 * @memberof typedefs
 */

/**
 * @exports DeleteFilesBody
 * @typedef {import('aladin-data-provider').DeleteFilesBody} DeleteFilesBody
 * @memberof typedefs
 */
...
/**
 * @exports MongoFile
 * @typedef {import('@aladin/data-schemas').IMongoFile} MongoFile
 * @memberof typedefs
 */

/**
 * @exports ISession
 * @typedef {import('@aladin/data-schemas').ISession} ISession
 * @memberof typedefs
 */

/**
 * @exports IBalance
 * @typedef {import('@aladin/data-schemas').IBalance} IBalance
 * @memberof typedefs
 */

/**
 * @exports IUser
 * @typedef {import('@aladin/data-schemas').IUser} IUser
 * @memberof typedefs
 */

/**
 * @exports IPluginAuth
 * @typedef {import('@aladin/data-schemas').IPluginAuth} IPluginAuth
 * @memberof typedefs
 */

/**
 * @exports IRole
 * @typedef {import('@aladin/data-schemas').IRole} IRole
 * @memberof typedefs
 */
 ...
 * @typedef {import('aladin-data-provider').EModelEndpoint} EModelEndpoint
 * @memberof typedefs
 */

/**
 * @exports TEndpointOption
 * @typedef {import('aladin-data-provider').TEndpointOption} TEndpointOption
 * @memberof typedefs
 */

/**
 * @exports TAttachment
 * @typedef {import('aladin-data-provider').TAttachment} TAttachment
 * @memberof typedefs
 */

/**
 * @exports AssistantCreateParams
 * @typedef {import('aladin-data-provider').AssistantCreateParams} AssistantCreateParams
 * @memberof typedefs
 */

/**
 * @exports AssistantUpdateParams
 * @typedef {import('aladin-data-provider').AssistantUpdateParams} AssistantUpdateParams
 * @memberof typedefs
 */

/**
 * @exports AssistantListParams
 * @typedef {import('aladin-data-provider').AssistantListParams} AssistantListParams
 * @memberof typedefs
 */

/**
 * @exports AssistantListResponse
 * @typedef {import('aladin-data-provider').AssistantListResponse} AssistantListResponse
 * @memberof typedefs
 */

/**
 * @exports ContentPart
 * @typedef {import('aladin-data-provider').ContentPart} ContentPart
 * @memberof typedefs
 */

/**
 * @exports StepTypes
 * @typedef {import('aladin-data-provider').StepTypes} StepTypes
 * @memberof typedefs
 */

/**
 * @exports TContentData
 * @typedef {import('aladin-data-provider').TContentData} TContentData
 * @memberof typedefs
 */
 ...
 * @typedef {import('aladin-data-provider').PartMetadata} PartMetadata
 * @memberof typedefs
 */
 ...
 * @typedef {import('aladin-data-provider').TAssistantEndpoint} TAssistantEndpoint
 * @memberof typedefs
 */

/**
 * @exports TAgentsEndpoint
 * @typedef {import('aladin-data-provider').TAgentsEndpoint} TAgentsEndpoint
 * @memberof typedefs
 */

/**
 * @exports Agent
 * @typedef {import('aladin-data-provider').Agent} Agent
 * @memberof typedefs
 */

/**
 * @exports TEphemeralAgent
 * @typedef {import('aladin-data-provider').TEphemeralAgent} TEphemeralAgent
 * @memberof typedefs
 */

/**
 * @exports TWebSearchKeys
 * @typedef {import('@aladin/data-schemas').TWebSearchKeys} TWebSearchKeys
 * @memberof typedefs
 */

/**
 * @exports AgentToolResources
 * @typedef {import('aladin-data-provider').AgentToolResources} AgentToolResources
 * @memberof typedefs
 */

/**
 * @exports AgentCreateParams
 * @typedef {import('aladin-data-provider').AgentCreateParams} AgentCreateParams
 * @memberof typedefs
 */

/**
 * @exports AgentUpdateParams
 * @typedef {import('aladin-data-provider').AgentUpdateParams} AgentUpdateParams
 * @memberof typedefs
 */

/**
 * @exports AgentListParams
 * @typedef {import('aladin-data-provider').AgentListParams} AgentListParams
 * @memberof typedefs
 */

/**
 * @exports AgentListResponse
 * @typedef {import('aladin-data-provider').AgentListResponse} AgentListResponse
 * @memberof typedefs
 */
 ...
 * @typedef {import('aladin-data-provider').TUpdateResourcePermissionsRequest} TUpdateResourcePermissionsRequest
 * @memberof typedefs
 */

/**
 * @exports TUpdateResourcePermissionsResponse
 * @typedef {import('aladin-data-provider').TUpdateResourcePermissionsResponse} TUpdateResourcePermissionsResponse
 * @memberof typedefs
 */

/**
 * @exports AppConfig
 * @typedef {import('@aladin/data-schemas').AppConfig} AppConfig
 * @memberof typedefs
 */

/**
 * @exports JsonSchemaType
 * @typedef {import('@aladin/data-schemas').JsonSchemaType} JsonSchemaType
 * @memberof typedefs
 */

/**
 * @exports MCPServers
 * @typedef {import('@aladin/api').MCPServers} MCPServers
 * @memberof typedefs
 */
...
/**
 * @exports MCPManager
 * @typedef {import('@aladin/api').MCPManager} MCPManager
 * @memberof typedefs
 */

/**
 * @exports MCPConnection
 * @typedef {import('@aladin/api').MCPConnection} MCPConnection
 * @memberof typedefs
 */

/**
 * @exports LCFunctionTool
 * @typedef {import('@aladin/api').LCFunctionTool} LCFunctionTool
 * @memberof typedefs
 */

/**
 * @exports FlowStateManager
 * @typedef {import('@aladin/api').FlowStateManager} FlowStateManager
 * @memberof typedefs
 */

/**
 * @exports LCAvailableTools
 * @typedef {import('@aladin/api').LCAvailableTools} LCAvailableTools
 * @memberof typedefs
 */

/**
 * @exports LCTool
 * @typedef {import('@aladin/api').LCTool} LCTool
 * @memberof typedefs
 */

/**
 * @exports FormattedContent
 * @typedef {import('@aladin/api').FormattedContent} FormattedContent
 * @memberof typedefs
 */
 ...
 * @typedef {import('@aladin/data-schemas').FunctionTool} FunctionTool
 * @memberof typedefs
 */
 ...
 * @property {string} messageId - The ID of the message (from Aladin).
 ...
 * @typedef {import('aladin-data-provider').TForkConvoResponse} TForkConvoResponse
 * @memberof typedefs
 */

/**
 * @exports TForkConvoRequest
 * @typedef {import('aladin-data-provider').TForkConvoRequest} TForkConvoRequest
 * @memberof typedefs
 */
