...
const { ResourceType, SystemRoles, Tools, actionDelimiter } = require('aladin-data-provider');
const { GLOBAL_PROJECT_NAME, EPHEMERAL_AGENT_ID, mcp_all, mcp_delimiter } =
  require('aladin-data-provider').Constants;
const {
 ...
 * @param {import('@aladin/agents').ClientOptions} [params.model_parameters]
 * @returns {Promise<Agent|null>} The agent document as a plain object, or null if not found.
 */
