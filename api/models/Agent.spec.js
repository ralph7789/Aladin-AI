...
const { agentSchema } = require('@aladin/data-schemas');
const { MongoMemoryServer } = require('mongodb-memory-server');
const { AccessRoleIds, ResourceType, PrincipalType } = require('aladin-data-provider');
const {
  getAgent,
  loadAgent,
  createAgent,
...
/**
 * @type {import('mongoose').Model<import('@aladin/data-schemas').IAgent>}
 */
let Agent;
...
describe('models/Agent', () => {
  ...
  describe('Agent CRUD Operations', () => {
    ...
    test('should handle ephemeral agent loading', async () => {
      ...
      const originalModule = jest.requireActual('aladin-data-provider');
      ...
      jest.doMock('aladin-data-provider', () => mockDataProvider);

      expect(agentId).toBeDefined();
      expect(endpoint).toBeDefined();

      jest.dontMock('aladin-data-provider');
    });
  ...
  describe('Load Agent Functionality', () => {
    ...
    test('should test ephemeral agent loading logic', async () => {
      const { EPHEMERAL_AGENT_ID } = require('aladin-data-provider').Constants;
