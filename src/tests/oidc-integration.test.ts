...
describe('OpenID Connect Federated Provider Token Integration', () => {
  ...
  describe('processOpenIDPlaceholders', () => {
    ...
    it('should replace OpenID Connect token placeholders', () => {
      const template = 'Bearer {{ALADIN_OPENID_TOKEN}}';
    ...
    it('should replace specific OpenID Connect placeholders', () => {
      const template = `
        Access: {{ALADIN_OPENID_ACCESS_TOKEN}}
        ID: {{ALADIN_OPENID_ID_TOKEN}}
        User: {{ALADIN_OPENID_USER_ID}}
        Email: {{ALADIN_OPENID_USER_EMAIL}}
        Name: {{ALADIN_OPENID_USER_NAME}}
    ...
    it('should handle missing token fields gracefully', () => {
      ...
      const template = 'Token: {{ALADIN_OPENID_TOKEN}}, Email: {{ALADIN_OPENID_USER_EMAIL}}';
  ...
  describe('Integration with resolveHeaders', () => {
    it('should resolve OpenID Connect placeholders in headers for Cognito', () => {
      const headers = {
        'Authorization': '{{ALADIN_OPENID_TOKEN}}',
        'X-User-ID': '{{ALADIN_OPENID_USER_ID}}',
        'X-User-Email': '{{ALADIN_OPENID_USER_EMAIL}}',
      };
    ...
    it('should work with specific access token placeholder', () => {
      const headers = {
        'Authorization': 'Bearer {{ALADIN_OPENID_ACCESS_TOKEN}}',
        'X-Cognito-ID-Token': '{{ALADIN_OPENID_ID_TOKEN}}',
      };
  ...
  describe('Integration with processMCPEnv', () => {
    it('should process OpenID Connect placeholders in MCP environment variables for Cognito', () => {
      const mcpOptions = {
        ...
        args: ['server.js'],
        env: {
          'COGNITO_ACCESS_TOKEN': '{{ALADIN_OPENID_TOKEN}}',
          'USER_ID': '{{ALADIN_OPENID_USER_ID}}',
          'USER_EMAIL': '{{ALADIN_OPENID_USER_EMAIL}}',
        },
      };
    ...
    it('should process OpenID Connect placeholders in MCP headers for HTTP transport', () => {
      const mcpOptions = {
        ...
        headers: {
          'Authorization': 'Bearer {{ALADIN_OPENID_ACCESS_TOKEN}}',
          'X-Cognito-User-Info': '{{ALADIN_OPENID_USER_EMAIL}}',
          'X-Cognito-ID-Token': '{{ALADIN_OPENID_ID_TOKEN}}',
        },
      };
    ...
    it('should handle AWS-specific MCP server configuration', () => {
      const awsMcpOptions = {
        ...
        env: {
          'AWS_COGNITO_TOKEN': '{{ALADIN_OPENID_ACCESS_TOKEN}}',
          'AWS_COGNITO_ID_TOKEN': '{{ALADIN_OPENID_ID_TOKEN}}',
          'COGNITO_USER_SUB': '{{ALADIN_OPENID_USER_ID}}',
        },
      };
  ...
  describe('Security and Edge Cases', () => {
    it('should not process OpenID Connect placeholders for expired tokens', () => {
      ...
      expect(resolvedHeaders['Authorization']).toBe('Bearer {{ALADIN_OPENID_TOKEN}}');
    });
    ...
    it('should handle multiple placeholder instances in same string', () => {
      const template = '{{ALADIN_OPENID_TOKEN}}-{{ALADIN_OPENID_TOKEN}}-{{ALADIN_OPENID_USER_ID}}';
