...
import { EModelEndpoint, normalizeEndpointName } from 'aladin-data-provider';
import type { TCustomConfig } from 'aladin-data-provider';

/**
 * Sets up Model Specs from the config (`aladin.yaml`) file.
...
For more information, see the documentation at https://www.aladin.ai/docs/configuration/aladin_yaml/object_structure/model_specs#endpoint`);
      continue;
    }
