import { EModelEndpoint, agentsEndpointSchema } from 'aladin-data-provider';
import type { TCustomConfig, TAgentsEndpoint } from 'aladin-data-provider';

/**
 * Sets up the Agents configuration from the config (`aladin.yaml`) file.
