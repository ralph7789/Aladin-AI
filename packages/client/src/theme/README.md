# Dynamic Theme System for @aladin/client
...
```tsx
import { ThemeProvider } from '@aladin/client';
...
module.exports = {
  content: [
    ...
    './node_modules/@aladin/client/dist/**/*.js',
  ],
  darkMode: ['class'],
  theme: {
    extend: {
...
```tsx
import { IThemeRGB } from '@aladin/client';
...
```tsx
import { useTheme } from '@aladin/client';
...
**After:**
```tsx
import { ThemeContext, ThemeProvider } from '@aladin/client';
```
...
```tsx
import { ThemeProvider, defaultTheme, darkTheme } from '@aladin/client';
...
This theme system is part of the @aladin/client package. 