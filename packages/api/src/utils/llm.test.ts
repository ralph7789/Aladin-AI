import { extractAladinParams } from './llm';

describe('extractAladinParams', () => {
  it('should return defaults when options is undefined', () => {
    const result = extractAladinParams(undefined);
  ...
  it('should return defaults when options is null', () => {
    const result = extractAladinParams();
  ...
  it('should extract all Aladin params and leave model options', () => {
    const options = {
      resendFiles: false,
    ...
    const result = extractAladinParams(options);
  ...
  it('should handle null values for Aladin params', () => {
    const options = {
      resendFiles: true,
      promptPrefix: null,
  ...
  it('should only extract known Aladin params', () => {
    const options = {
      resendFiles: false,
  ...
  it('should not mutate the original options object', () => {
    ...
    extractAladinParams(options);

    // Original object should remain unchanged
    expect(options).toEqual(originalOptions);
  });

  it('should handle undefined values for optional Aladin params', () => {
    const options = {
      resendFiles: false,
