import { loadDefaultInterface } from '@aladin/data-schemas';
import { SystemRoles, Permissions, PermissionTypes, roleDefaults } from 'aladin-data-provider';
import type { TConfigDefaults, TCustomConfig } from 'aladin-data-provider';
