import { EModelEndpoint, extractEnvVariable, normalizeEndpointName } from 'aladin-data-provider';
import type { TCustomEndpoints, TEndpoint, TConfig } from 'aladin-data-provider';
