...
import type { JsonSchemaType } from '@aladin/data-schemas';
...
export class MCPServerInspector {
  ...
  /**
   * Converts server tools to Aladin-compatible tool functions format.
   * @param serverName - The name of the server
   * @param connection - The MCP connection
   * @returns Tool functions formatted for Aladin
   */
