...
import { Providers } from '@aladin/agents';
import { Tools } from 'aladin-data-provider';
import type { MemoryArtifact } from 'aladin-data-provider';
...
describe('processMemory - GPT-5+ handling', () => {
  ...
  beforeEach(() => {
    ...
    const { Run } = jest.requireMock('@aladin/agents');
