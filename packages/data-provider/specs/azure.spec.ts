...
describe('validateAzureGroups with modelGroupMap and groupMap', () => {
  ...
  it('should list all expected models in both modelGroupMap and groupMap', () => {
    ...
    // Check groupMap for 'aladin-westus'
    expect(groupMap).toHaveProperty('aladin-westus');
    expect(groupMap['aladin-westus']).toEqual(
    ...
    // Check groupMap for 'aladin-eastus'
    expect(groupMap).toHaveProperty('aladin-eastus');
    expect(groupMap['aladin-eastus']).toEqual(
      expect.objectContaining({
        apiKey: '${EASTUS_API_KEY}',
        instanceName: 'aladin-eastus',
        deploymentName: 'gpt-4-turbo',
    ...
    expect(azureOptions1).toEqual({
      ...
      azureOpenAIApiInstanceName: 'aladin-westus',
    ...
    expect(azureOptions2).toEqual({
      ...
      azureOpenAIApiInstanceName: 'aladin-eastus',
