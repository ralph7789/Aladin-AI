...
(async () => {
  ...
  console.purple('Removing all tags for Aladin `deployed` images...');
  const repositories = ['ghcr.io/danny-avila/aladin-dev-api', 'aladin-client'];
  ...
  console.purple('Pulling latest Aladin images...');
