...
/**
 * Aladin Cache Flush Utility
 *
 * This script flushes the cache store used by Aladin, whether it's
...
DESCRIPTION:
  Flushes the cache store used by Aladin. Automatically detects
...
async function restartRecommendation() {
  ...
  console.log('   consider restarting the Aladin backend:');
  console.log('');
...
async function main() {
  ...
  console.log('🧹 Aladin Cache Flush Utility');
  console.log('================================');
