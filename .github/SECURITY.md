...
- **Option 3: Discord Server**: You can join our [Discord community](https://discord.aladin.ai) and initiate first contact in the `#issues` channel. However, please ensure that initial contact through Discord does not include any sensitive details.
...
We are committed to maintaining the security of our open-source project, Aladin, and promptly addressing any identified vulnerabilities. To ensure the security of our project, we adhere to the following practices:
...
- Repository: [Aladin](https://github.aladin.ai)

## Contact

If you have any questions or concerns regarding the security of our project, please join our [Discord community](https://discord.aladin.ai) and report them in the appropriate channel. You can also reach out to us by [opening an issue](https://github.com/danny-avila/Aladin/issues/new) on GitHub. Please note that the response time may vary depending on the nature and severity of the inquiry.
